<?php
class Buyshop_Testimonial_Block_Adminhtml_Testimonial_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form {
    ...
    protected function _prepareForm() {
        ...
        $fieldset->addField('sidebar', 'select', array(
            ...
            'values' => Buyshop_Testimonial_Block_Adminhtml_Testimonial_Grid::getValueArray6(),
            'name' => 'sidebar',
        ));
        ...
        $fieldset->addField('status', 'select', array(
            ...
            'values' => Buyshop_Testimonial_Block_Adminhtml_Testimonial_Grid::getValueArray8(),
            'name' => 'status',
        ));
